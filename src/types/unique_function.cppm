...
export module beyond.core:unique_function;

namespace beyond {

export template <typename R, typename... Args> class unique_function;
...
// deduction guides
export template <class R, typename... Args>
...
export template <class Func, class = std::enable_if_t<!std::is_pointer_v<Func>>>
