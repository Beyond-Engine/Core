...
export module beyond.core:math.functions;
...
[[nodiscard]] auto sin(Angle arg) noexcept -> Angle::ValueType
{
 ...
 */
template <typename Angle>
[[nodiscard]] auto cos(Angle arg) noexcept -> Angle::ValueType
{
  beyond::TRadian r{arg};
 ...
 */
template <typename Angle>
[[nodiscard]] auto tan(Angle arg) noexcept -> Angle::ValueType
{
  beyond::TRadian r{arg};
...
[[nodiscard]] auto asin(T arg) noexcept -> TRadian<T>
...
[[nodiscard]] auto asin(T arg) noexcept -> TRadian<double>
 ...
 */
template <std::floating_point T>
[[nodiscard]] auto acos(T arg) noexcept -> TRadian<T>
 ...
 */
template <std::integral T>
[[nodiscard]] auto acos(T arg) noexcept -> TRadian<double>
 ...
 */
template <std::floating_point T>
[[nodiscard]] auto atan(T arg) noexcept -> TRadian<T>
 ...
 */
template <std::integral T>
[[nodiscard]] auto atan(T arg) noexcept -> TRadian<double>
...
[[nodiscard]] auto atan2(T1 y, T2 x) noexcept
{
 ...
 */
template <std::floating_point T> [[nodiscard]] auto constexpr sqrt(T x) -> T
{
