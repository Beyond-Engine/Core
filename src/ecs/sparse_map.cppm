 ...
 * to store entities and their associated data.
 * @ingroup ecs
 */
 ...
 */
export template <typename Handle, typename T> class SparseMap {
public:
  ...
  [[nodiscard]] auto empty() const noexcept -> bool { return handles_.empty(); }
  ...
  auto reserve(SizeType capacity) -> void { handles_.reserve(capacity); }
   ...
   * in the sparse map, nullptr otherwise
   */
