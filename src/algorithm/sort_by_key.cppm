...
export module beyond.core:algorithm.sort_by_key;
...
export template <typename KeyItr, typename MappedItr> struct SortByKeyIterator {
  using iterator_category = std::random_access_iterator_tag;
  using difference_type = std::int64_t;
  using value_type = detail::SortByKeyVal<KeyItr, MappedItr>;
  using pointer = value_type*;
  using reference = detail::SortByKeyRef<KeyItr, MappedItr>;
 ...
 */
export template <std::random_access_iterator KeyItr,
                 std::random_access_iterator MappedItr>
constexpr void sort_by_key(KeyItr keys_begin, KeyItr keys_end,
                           MappedItr mapped_begin)
{
  std::sort(SortByKeyIterator<KeyItr, MappedItr>{0, keys_begin, mapped_begin},
            SortByKeyIterator<KeyItr, MappedItr>{
