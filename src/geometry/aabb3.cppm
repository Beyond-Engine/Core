...
export module beyond.core:geometry.aabb3;
...
export [[nodiscard]] auto to_string(const AABB3& box) -> std::string;
export auto operator<<(std::ostream& os, const AABB3& box) -> std::ostream&;

/**
 * @brief Find the union of two AABBs
 * @related AABB3
 */
export [[nodiscard]] constexpr auto merge(const AABB3& box0, const AABB3& box1)
    -> AABB3
{
